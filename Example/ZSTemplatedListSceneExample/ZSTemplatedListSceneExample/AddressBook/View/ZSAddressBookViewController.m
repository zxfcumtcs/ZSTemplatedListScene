//
//  ZSAddressBookViewController.m
//
//  Created by ZS on 2018/8/8.
//  Copyright © 2018年 ZS. All rights reserved.
//

#import "ZSAddressBookViewController.h"
#import "ZSAddressBookManager.h"
#import "ZSCEvent.h"
#import "ZSModule.h"

@interface ZSAddressBookViewController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) id<ZSAddressBookManager> manager;
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UIView *errorEmptyView;

@end

@implementation ZSAddressBookViewController

- (instancetype)init
{
    if (self = [super init]) {
        _manager = [[ZSAddressBookManager alloc] init];
    }
